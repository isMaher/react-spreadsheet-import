import { Box, Button, Code, Link } from "@chakra-ui/react"
  ...
  return (
    <>
      <Box py={20} display="flex" gap="8px" alignItems="center">
        <Button onClick={() => setOpen(true)} border="2px solid #7069FA" p="8px" borderRadius="8px">
          Open Flow
        </Button>
      ...
      <ReactSpreadsheetImport {...mockRsiValues} isOpen={open} onClose={() => setOpen(false)} onSubmit={setData} />
      {!!data && (
